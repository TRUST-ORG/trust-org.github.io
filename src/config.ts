...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: false,
		src: "assets/images/logo_black.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		{
			name: "Home",
			icon: "material-symbols:home", // Visit https://icones.js.org/ for icon codes
